...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",'https://trade-matrix.vercel.app','https://trade-matrix.net','https://www.trade-matrix.net/','https://trade-matrix-em5hasvxk-derricks-projects-71562c49.vercel.app/','https://goldencash.vercel.app/','https://goldencash.live/','https://tm-hub.com/','https://trade-matrix-v2.vercel.app/'
]
CORS_ALLOW_METHODS = [
    "GET",
    "POST",
