...
SECRET_KEY = 'django-insecure-ub+e%4=2!&9t*jkcer0!)4ve(3&^&8$=%w7msfoi^dy628re5%'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173","https://store-manager-ten.vercel.app", 'https://trade-matrix.vercel.app','https://trade-matrix.com'
]
ORS_ALLOW_METHODS = [
    "GET",
    "POST",
